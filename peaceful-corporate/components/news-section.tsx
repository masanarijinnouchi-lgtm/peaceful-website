    ...
    <section id="news-section" className="relative z-10 flex min-h-[50vh] flex-col justify-center px-8 py-24 bg-background">
      <div className="mx-auto w-full max-w-5xl">
        <div className="mb-12 flex items-baseline justify-between">
          <h2
            className={`font-bold tracking-tight text-4xl md:text-5xl lg:text-6xl transition-all duration-1000 ${
          ...
          <Link 
            href="/news" 
            className={`text-sm font-medium tracking-widest text-neon-blue transition-all duration-1000 hover:text-white delay-300 ${
            ...
            <Link key={index} href={item.href} className="group block">
              ...
              >
                <div className="flex flex-col md:flex-row md:items-baseline md:gap-8">
                  <time className="mb-1 text-sm font-medium text-neon-blue/60 transition-colors group-hover:text-neon-blue md:mb-0">
                    {item.date}
                  </time>
                  <h3 className="text-xl font-bold tracking-tight text-foreground transition-colors group-hover:text-neon-blue md:text-2xl">
                    {item.title}
                  </h3>
                </div>
              </article>
